<template>
	<main class="main skeleton-body mb-5">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-xl-8cols col-lg-9">
					...
					<div
						class="product-single-container product-single-info mb-0"
						v-if="product"
					>
						<div class="row">
					...
					<div class="product-single-tabs custom-product-single-tabs mb-4">
						<div
							class="skel-group"
							v-if="!product"
						>
