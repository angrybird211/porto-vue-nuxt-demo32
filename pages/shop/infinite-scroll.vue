	...
	<main class="main skeleton-body">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-xl-8cols col-lg-6 col-md-8 main-content">
					...
					<pv-product-list-four :category-list="categoryList"></pv-product-list-four>
				</div>
...
import PvProductListFour from '~/components/partials/shop/product-list/PvProductListFour';
